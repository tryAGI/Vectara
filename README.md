...
## Features 🔥
- Fully generated C# SDK based on [official Vectara OpenAPI specification](https://docs.vectara.com/vectara-oas-v2.yaml) using [AutoSDK](https://github.com/HavenDV/AutoSDK)
