...
namespace Vectara
{
    ...
    public sealed partial class CorpusRole
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Vectara.JsonConverters.CorpusRoleRoleJsonConverter))]
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Vectara.CorpusRoleRole Role { get; set; }
        ...
        public CorpusRole(
            string corpusKey,
            global::Vectara.CorpusRoleRole role)
        {
