...
namespace Vectara
{
    public partial class AgentsClient
    {
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_GetMemoryHistorySecurityRequirement0 =
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_GetMemoryHistorySecurityRequirement1 =
            new global::Vectara.EndPointSecurityRequirement
            {
                Authorizations = new global::Vectara.EndPointAuthorizationRequirement[]
                {                    new global::Vectara.EndPointAuthorizationRequirement
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement[] s_GetMemoryHistorySecurityRequirements =
            new global::Vectara.EndPointSecurityRequirement[]
            {                s_GetMemoryHistorySecurityRequirement0,
                s_GetMemoryHistorySecurityRequirement1,
            };
        partial void PrepareGetMemoryHistoryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            ref string agentKey);
        partial void PrepareGetMemoryHistoryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? requestTimeout,
            int? requestTimeoutMillis,
            string agentKey);
        partial void ProcessGetMemoryHistoryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetMemoryHistoryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get agent memory history<br/>
        /// Retrieve the version history of the agent's `_learned_memory` skill.<br/>
        /// Each entry is a full snapshot of the memory content at that version, ordered by version ascending.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.AgentMemoryHistory> GetMemoryHistoryAsync(
            string agentKey,
        ...
        {
            var __response = await GetMemoryHistoryAsResponseAsync(
                agentKey: agentKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.AgentMemoryHistory>> GetMemoryHistoryAsResponseAsync(
            string agentKey,
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            global::Vectara.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetMemoryHistoryArguments(
            ...
            var __authorizations = global::Vectara.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetMemoryHistorySecurityRequirements,
                operationName: "GetMemoryHistoryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vectara.PathBuilder(
                                path: $"/v2/agents/{agentKey}/memory/history",
            ...
            if (requestTimeoutMillis != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetMemoryHistoryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetMemoryHistoryAsync",
                                pathTemplate: "$\"/v2/agents/{agentKey}/memory/history\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetMemoryHistoryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetMemoryHistoryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vectara.AgentMemoryHistory.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.AgentMemoryHistory>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vectara.AgentMemoryHistory.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
