...
namespace Vectara
{
    public partial interface IInstructionsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Vectara.Instruction> GetAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.Instruction>> GetAsResponseAsync(
            string instructionId,
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            int? version = default,
