...
{
    /// <summary>
    /// A request to create a document. The request takes multiple forms, depending on how much control you need over the resulting document parts. You can create a document with natural structure, and the platform creates the document parts for you. Otherwise, you can create a document with all the document parts explicitly specified. A document part is the search result item in search and Retrieval Augmented Generation endpoints.<br/>
