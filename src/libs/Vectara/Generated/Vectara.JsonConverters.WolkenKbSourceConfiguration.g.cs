...
namespace Vectara.JsonConverters
{
    ...
    public class WolkenKbSourceConfigurationJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vectara.WolkenKbSourceConfiguration>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (@base == null && wolkenKbSourceConfigurationVariant2 == null)
            {
                try
                {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            else if (value.IsWolkenKbSourceConfigurationVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(object), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<object?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(object).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.WolkenKbSourceConfigurationVariant2!, typeInfo);
            }
        }
    }
}