...
namespace Vectara
{
    public partial class A2aClient
    {
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_GetAgentCardWellKnownSecurityRequirement0 =
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_GetAgentCardWellKnownSecurityRequirement1 =
            new global::Vectara.EndPointSecurityRequirement
            {
                Authorizations = new global::Vectara.EndPointAuthorizationRequirement[]
                {                    new global::Vectara.EndPointAuthorizationRequirement
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement[] s_GetAgentCardWellKnownSecurityRequirements =
            new global::Vectara.EndPointSecurityRequirement[]
            {                s_GetAgentCardWellKnownSecurityRequirement0,
                s_GetAgentCardWellKnownSecurityRequirement1,
            };
        partial void PrepareGetAgentCardWellKnownArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            ref string agentKey);
        partial void PrepareGetAgentCardWellKnownRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? requestTimeout,
            int? requestTimeoutMillis,
            string agentKey);
        partial void ProcessGetAgentCardWellKnownResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAgentCardWellKnownResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.A2aV03AgentCard> GetAgentCardWellKnownAsync(
            string agentKey,
        ...
        {
            var __response = await GetAgentCardWellKnownAsResponseAsync(
                agentKey: agentKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.A2aV03AgentCard>> GetAgentCardWellKnownAsResponseAsync(
            string agentKey,
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            global::Vectara.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAgentCardWellKnownArguments(
            ...
            var __authorizations = global::Vectara.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetAgentCardWellKnownSecurityRequirements,
                operationName: "GetAgentCardWellKnownAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vectara.PathBuilder(
                                path: $"/v2/agents/{agentKey}/.well-known/agent-card.json",
            ...
            if (requestTimeoutMillis != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAgentCardWellKnownRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetAgentCardWellKnownAsync",
                                pathTemplate: "$\"/v2/agents/{agentKey}/.well-known/agent-card.json\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAgentCardWellKnownResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAgentCardWellKnownResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vectara.A2aV03AgentCard.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.A2aV03AgentCard>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vectara.A2aV03AgentCard.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
