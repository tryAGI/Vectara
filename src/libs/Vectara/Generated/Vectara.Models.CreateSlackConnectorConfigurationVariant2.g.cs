...
namespace Vectara
{
    ...
    public sealed partial class CreateSlackConnectorConfigurationVariant2
    {
        ...
        /// <summary>
        /// When true, the agent responds to follow-up replies in any thread it has already replied in or started, without requiring a new @-mention. Starting a new thread still requires an @-mention.<br/>
        /// Default Value: false
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("respond_to_thread_replies")]
        public bool? RespondToThreadReplies { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateSlackConnectorConfigurationVariant2" /> class.
        /// </summary>
        /// <param name="type">
        /// The type of connector configuration.<br/>
        /// Default Value: slack<br/>
...
#endif
        public CreateSlackConnectorConfigurationVariant2(
            string type,
            string botToken,
            string signingSecret,
            string apiAppId,
            bool? respondToThreadReplies)
        {
            ...
            this.RespondToThreadReplies = respondToThreadReplies;
        }
