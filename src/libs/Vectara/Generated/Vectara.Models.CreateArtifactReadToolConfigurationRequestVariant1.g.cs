...
namespace Vectara
{
    ...
    public sealed partial class CreateArtifactReadToolConfigurationRequestVariant1
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateArtifactReadToolConfigurationRequestVariant1" /> class.
        /// </summary>
        /// <param name="type">
        /// This should always be `artifact_read`.<br/>
        /// Default Value: artifact_read<br/>
...
#endif
        public CreateArtifactReadToolConfigurationRequestVariant1(
            string type,
