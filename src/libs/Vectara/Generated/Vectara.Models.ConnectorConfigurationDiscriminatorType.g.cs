    ...
    public static class ConnectorConfigurationDiscriminatorTypeExtensions
    {
        ...
        public static string ToValueString(this ConnectorConfigurationDiscriminatorType value)
        {
            return value switch
            {
                ...
                ConnectorConfigurationDiscriminatorType.Widget => "widget",
                ConnectorConfigurationDiscriminatorType.Zoom => "zoom",
        ...
        public static ConnectorConfigurationDiscriminatorType? ToEnum(string value)
        {
            return value switch
            {
                ...
                "widget" => ConnectorConfigurationDiscriminatorType.Widget,
                "zoom" => ConnectorConfigurationDiscriminatorType.Zoom,
                _ => null,
            };
        }
    }
