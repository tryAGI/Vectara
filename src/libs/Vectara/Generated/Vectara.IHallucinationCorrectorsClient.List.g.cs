...
namespace Vectara
{
    public partial interface IHallucinationCorrectorsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Vectara.ListHallucinationCorrectorsResponse> ListAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.ListHallucinationCorrectorsResponse>> ListAsResponseAsync(
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            string? filter = default,
            int? limit = default,
