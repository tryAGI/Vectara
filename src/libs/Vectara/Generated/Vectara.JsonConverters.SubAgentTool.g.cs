...
{
    /// <inheritdoc />
    public class SubAgentToolJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vectara.SubAgentTool>
    {
        /// <inheritdoc />
        public override global::Vectara.SubAgentTool Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Vectara.SubAgentToolVariant2? value2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vectara.SubAgentToolVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vectara.SubAgentToolVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Vectara.SubAgentToolVariant2).Name}");
            ...
            var __value = new global::Vectara.SubAgentTool(
                value1,
        ...
        public override void Write(
            ...
            global::Vectara.SubAgentTool value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
