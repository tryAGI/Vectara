...
namespace Vectara
{
    public partial class AgentArtifactsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.SessionArtifact>> Get3AsResponseAsync(
            string agentKey,
            string sessionKey,
            string artifactId,
            int? requestTimeout = default,
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.SessionArtifact>(
                                        statusCode: __response.StatusCode,
