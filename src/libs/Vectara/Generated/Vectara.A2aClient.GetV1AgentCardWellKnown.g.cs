...
namespace Vectara
{
    public partial class A2aClient
    {
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_GetV1AgentCardWellKnownSecurityRequirement0 =
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_GetV1AgentCardWellKnownSecurityRequirement1 =
            new global::Vectara.EndPointSecurityRequirement
            {
                Authorizations = new global::Vectara.EndPointAuthorizationRequirement[]
                {                    new global::Vectara.EndPointAuthorizationRequirement
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement[] s_GetV1AgentCardWellKnownSecurityRequirements =
            new global::Vectara.EndPointSecurityRequirement[]
            {                s_GetV1AgentCardWellKnownSecurityRequirement0,
                s_GetV1AgentCardWellKnownSecurityRequirement1,
            };
        partial void PrepareGetV1AgentCardWellKnownArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            ref string agentKey);
        partial void PrepareGetV1AgentCardWellKnownRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? requestTimeout,
            int? requestTimeoutMillis,
            string agentKey);
        partial void ProcessGetV1AgentCardWellKnownResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetV1AgentCardWellKnownResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.A2aV1AgentCard> GetV1AgentCardWellKnownAsync(
            string agentKey,
        ...
        {
            var __response = await GetV1AgentCardWellKnownAsResponseAsync(
                agentKey: agentKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.A2aV1AgentCard>> GetV1AgentCardWellKnownAsResponseAsync(
            string agentKey,
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            global::Vectara.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetV1AgentCardWellKnownArguments(
            ...
            var __authorizations = global::Vectara.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetV1AgentCardWellKnownSecurityRequirements,
                operationName: "GetV1AgentCardWellKnownAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vectara.PathBuilder(
                                path: $"/v2/agents/{agentKey}/.well-known/a2a/v1/agent-card.json",
            ...
            if (requestTimeoutMillis != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetV1AgentCardWellKnownRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetV1AgentCardWellKnown",
                                methodName: "GetV1AgentCardWellKnownAsync",
                                pathTemplate: "$\"/v2/agents/{agentKey}/.well-known/a2a/v1/agent-card.json\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetV1AgentCardWellKnownResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetV1AgentCardWellKnownResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vectara.A2aV1AgentCard.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.A2aV1AgentCard>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vectara.A2aV1AgentCard.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
