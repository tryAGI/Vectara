...
namespace Vectara
{
    public partial class A2aClient
    {
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_GetExtendedAgentCardSecurityRequirement0 =
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_GetExtendedAgentCardSecurityRequirement1 =
            new global::Vectara.EndPointSecurityRequirement
            {
                Authorizations = new global::Vectara.EndPointAuthorizationRequirement[]
                {                    new global::Vectara.EndPointAuthorizationRequirement
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement[] s_GetExtendedAgentCardSecurityRequirements =
            new global::Vectara.EndPointSecurityRequirement[]
            {                s_GetExtendedAgentCardSecurityRequirement0,
                s_GetExtendedAgentCardSecurityRequirement1,
            };
        partial void PrepareGetExtendedAgentCardArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            ref string agentKey);
        partial void PrepareGetExtendedAgentCardRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            int? requestTimeout,
            int? requestTimeoutMillis,
            string agentKey);
        partial void ProcessGetExtendedAgentCardResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetExtendedAgentCardResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get A2A v1 extended agent card<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.A2aV1AgentCard> GetExtendedAgentCardAsync(
            string agentKey,
        ...
        {
            var __response = await GetExtendedAgentCardAsResponseAsync(
                agentKey: agentKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.A2aV1AgentCard>> GetExtendedAgentCardAsResponseAsync(
            string agentKey,
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            global::Vectara.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetExtendedAgentCardArguments(
            ...
            var __authorizations = global::Vectara.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetExtendedAgentCardSecurityRequirements,
                operationName: "GetExtendedAgentCardAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vectara.PathBuilder(
                                path: $"/v2/agents/{agentKey}/extendedAgentCard",
            ...
            if (requestTimeoutMillis != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetExtendedAgentCardRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetExtendedAgentCard",
                                methodName: "GetExtendedAgentCardAsync",
                                pathTemplate: "$\"/v2/agents/{agentKey}/extendedAgentCard\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetExtendedAgentCardResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetExtendedAgentCardResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
