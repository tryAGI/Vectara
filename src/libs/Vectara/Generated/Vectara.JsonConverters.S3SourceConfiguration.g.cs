...
{
    /// <inheritdoc />
    public class S3SourceConfigurationJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vectara.S3SourceConfiguration>
    {
        /// <inheritdoc />
        public override global::Vectara.S3SourceConfiguration Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            object? s3SourceConfigurationVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        s3SourceConfigurationVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (@base == null && s3SourceConfigurationVariant2 == null)
            {
                try
                {
                    var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vectara.BaseS3SourceConfiguration), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vectara.BaseS3SourceConfiguration> ??
            ...
            var __value = new global::Vectara.S3SourceConfiguration(
                @base,
        ...
        public override void Write(
            ...
            global::Vectara.S3SourceConfiguration value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsS3SourceConfigurationVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(object), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<object?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(object).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.S3SourceConfigurationVariant2!, typeInfo);
            }
        }
    }
}