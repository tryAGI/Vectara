                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return
                                        global::Vectara.PipelineDeadLetterEntry.FromJson(__content, JsonSerializerContext) ??
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    return
                                        await global::Vectara.PipelineDeadLetterEntry.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
