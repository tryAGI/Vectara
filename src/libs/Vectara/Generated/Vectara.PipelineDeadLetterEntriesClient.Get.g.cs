...
namespace Vectara
{
    public partial class PipelineDeadLetterEntriesClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.PipelineDeadLetterEntry> GetAsync(
            string pipelineKey,
            string deadLetterId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.PipelineDeadLetterEntry>> GetAsResponseAsync(
            string pipelineKey,
            string deadLetterId,
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vectara.PathBuilder(
                                path: $"/v2/pipelines/{pipelineKey}/dead_letters/{deadLetterId}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "Get",
                                methodName: "GetAsync",
                                pathTemplate: "$\"/v2/pipelines/{pipelineKey}/dead_letters/{deadLetterId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Permissions do not allow accessing this dead letter.
                            ...
                            // Pipeline or dead letter not found.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vectara.PipelineDeadLetterEntry.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.PipelineDeadLetterEntry>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vectara.PipelineDeadLetterEntry.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
