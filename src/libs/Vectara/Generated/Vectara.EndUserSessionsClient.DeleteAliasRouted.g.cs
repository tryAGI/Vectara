...
namespace Vectara
{
    public partial class EndUserSessionsClient
    {
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_DeleteAliasRoutedSecurityRequirement0 =
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement[] s_DeleteAliasRoutedSecurityRequirements =
            new global::Vectara.EndPointSecurityRequirement[]
        ...
        partial void PrepareDeleteAliasRoutedRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string aliasKey,
            string sessionKey);
        partial void ProcessDeleteAliasRoutedResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DeleteAliasRoutedAsync(
            string aliasKey,
            string sessionKey,
        ...
        {
            await DeleteAliasRoutedAsResponseAsync(
                aliasKey: aliasKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse> DeleteAliasRoutedAsResponseAsync(
            string aliasKey,
            string sessionKey,
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteAliasRoutedArguments(
            ...
            var __authorizations = global::Vectara.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteAliasRoutedSecurityRequirements,
                operationName: "DeleteAliasRoutedAsync");
            ...
            if (xVisitorId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteAliasRoutedRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteAliasRouted",
                                methodName: "DeleteAliasRoutedAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteAliasRoutedResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The session does not belong to the caller, or permissions do not allow deletion. Also returned when a presented connector id fails validation — the connector no longer admits the caller or does not front this alias.
