...
namespace Vectara
{
    public partial class AgentAliasesClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.AgentAlias> CreateAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.AgentAlias>> CreateAsResponseAsync(
            ...
            try
            {
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The request is malformed or the policy is invalid.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.AgentAlias>(
                                        statusCode: __response.StatusCode,
