...
{
    /// <summary>
    /// Request body that updates the agent's secrets. Names present in the map are added or replaced. Names absent from the map are left unchanged.<br/>
    /// A name mapped to `null` is removed. Secrets are stored encrypted at rest.
    /// </summary>
