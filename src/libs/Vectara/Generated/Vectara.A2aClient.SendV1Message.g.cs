...
namespace Vectara
{
    public partial class A2aClient
    {
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_SendV1MessageSecurityRequirement0 =
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_SendV1MessageSecurityRequirement1 =
            new global::Vectara.EndPointSecurityRequirement
            {
                Authorizations = new global::Vectara.EndPointAuthorizationRequirement[]
                {                    new global::Vectara.EndPointAuthorizationRequirement
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement[] s_SendV1MessageSecurityRequirements =
            new global::Vectara.EndPointSecurityRequirement[]
            {                s_SendV1MessageSecurityRequirement0,
                s_SendV1MessageSecurityRequirement1,
            };
        partial void PrepareSendV1MessageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            ref string agentKey,
            global::Vectara.A2aV1SendMessageRequest request);
        partial void PrepareSendV1MessageRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string agentKey,
            global::Vectara.A2aV1SendMessageRequest request);
        partial void ProcessSendV1MessageResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessSendV1MessageResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.A2aV1SendMessageResponse> SendV1MessageAsync(
            string agentKey,
        ...
        {
            var __response = await SendV1MessageAsResponseAsync(
                agentKey: agentKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.A2aV1SendMessageResponse>> SendV1MessageAsResponseAsync(
            string agentKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vectara.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SendV1MessageSecurityRequirements,
                operationName: "SendV1MessageAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vectara.PathBuilder(
                                path: $"/v2/agents/{agentKey}/message:send",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "SendV1Message",
                                methodName: "SendV1MessageAsync",
                                pathTemplate: "$\"/v2/agents/{agentKey}/message:send\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSendV1MessageResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vectara.A2aV1SendMessageResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.A2aV1SendMessageResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vectara.A2aV1SendMessageResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.A2aV1SendMessageResponse> SendV1MessageAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vectara.A2aV1SendMessageRequest
            {
                Tenant = tenant,
                Message = message,
            ...
            return await SendV1MessageAsync(
                requestTimeout: requestTimeout,
                requestTimeoutMillis: requestTimeoutMillis,
                agentKey: agentKey,
                request: __request,
