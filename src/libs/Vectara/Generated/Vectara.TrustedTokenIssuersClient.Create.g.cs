...
namespace Vectara
{
    public partial class TrustedTokenIssuersClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.TrustedTokenIssuer> CreateAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.TrustedTokenIssuer>> CreateAsResponseAsync(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "\"/v2/trusted_token_issuers\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The request is malformed, or `issuer` or `jwks_uri` is not an https URL.
                            ...
                            // Permissions do not allow registering trusted token issuers.
                            ...
                            // A registration for this issuer already exists.
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.TrustedTokenIssuer> CreateAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Vectara.CreateTrustedTokenIssuerRequest
            {
                Name = name,
