...
{
    /// <inheritdoc />
    public class EndUserAgentStreamedResponseJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vectara.EndUserAgentStreamedResponse>
    {
        /// <inheritdoc />
        public override global::Vectara.EndUserAgentStreamedResponse Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var discriminatorTypeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vectara.EndUserAgentStreamedResponseDiscriminator), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vectara.EndUserAgentStreamedResponseDiscriminator> ??
                            throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Vectara.EndUserAgentStreamedResponseDiscriminator)}");
            var discriminator = global::System.Text.Json.JsonSerializer.Deserialize(ref readerCopy, discriminatorTypeInfo);

            global::Vectara.EndUserInputMessageEvent? inputMessage = default;
            if (discriminator?.Type == global::Vectara.EndUserAgentStreamedResponseDiscriminatorType.InputMessage)
            {
            ...
            if (discriminator?.Type == global::Vectara.EndUserAgentStreamedResponseDiscriminatorType.AgentOutput)
            {
            ...
            if (discriminator?.Type == global::Vectara.EndUserAgentStreamedResponseDiscriminatorType.Error)
            {
            ...
            if (discriminator?.Type == global::Vectara.EndUserAgentStreamedResponseDiscriminatorType.StreamingAgentOutputEnd)
            {
        ...
        public override void Write(
            ...
            global::Vectara.EndUserAgentStreamedResponse value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
