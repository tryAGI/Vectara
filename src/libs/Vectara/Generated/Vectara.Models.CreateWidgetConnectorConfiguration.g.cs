...
{
    /// <summary>
    /// Write view of a widget connector's configuration, supplied on create. The widget fronts the alias the connector is created on; end-user sessions opened through the widget are created on that alias.<br/>
