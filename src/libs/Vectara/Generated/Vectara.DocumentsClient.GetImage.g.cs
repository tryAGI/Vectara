...
namespace Vectara
{
    public partial class DocumentsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.Image>> GetImageAsResponseAsync(
            string corpusKey,
            string documentId,
            string imageId,
            int? requestTimeout = default,
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.Image>(
                                        statusCode: __response.StatusCode,
