            ...
            try
            {
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The session does not belong to the caller, or permissions do not allow access. For an anonymous visitor, also returned when the session's connector no longer admits anonymous visitors.
