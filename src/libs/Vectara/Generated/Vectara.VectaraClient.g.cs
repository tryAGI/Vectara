...
namespace Vectara
{
    ...
    /// **API Roles** (account-wide, assigned to users): Roles like `owner`, `administrator`, `billing_administrator`, `corpus_administrator`, `corpus_developer`, `corpus_viewer`, `agent_administrator`, `agent_developer`, `agent_viewer`, `agent_user`, `pipeline_administrator`, `pipeline_viewer`, `viewer`, and `metrics_viewer`. These grant access across all resources of that type.<br/>
    ...
    public sealed partial class VectaraClient : global::Vectara.IVectaraClient, global::System.IDisposable
    {
        ...
        /// <summary>
        /// Creates a new instance of the VectaraClient with explicit options but no base URL override.
