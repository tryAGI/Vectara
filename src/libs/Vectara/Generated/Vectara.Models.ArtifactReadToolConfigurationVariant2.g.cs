...
namespace Vectara
{
    ...
    public sealed partial class ArtifactReadToolConfigurationVariant2
    {
        ...
        /// <summary>
        /// Configurable parameters for the artifact read tool. If not overridden, the agent must fill them in.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArtifactReadToolConfigurationVariant2" /> class.
        /// </summary>
        /// <param name="type">
        /// This should always be `artifact_read`.<br/>
        /// Default Value: artifact_read<br/>
...
#endif
        public ArtifactReadToolConfigurationVariant2(
            string type,
