...
namespace Vectara
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Vectara.AutoSDKRetryOptions Retry { get; set; } = new global::Vectara.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Vectara.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Vectara.IAutoSDKHook>();
        ...
        public global::Vectara.AutoSDKClientOptions AddHook(
            global::Vectara.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Vectara.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Vectara.AutoSDKClientOptions UseAuthorizationProvider(
            global::Vectara.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Vectara.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Vectara.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Vectara.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Vectara.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Vectara.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Vectara.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Vectara.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Vectara.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Vectara.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Vectara.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Vectara.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Vectara.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Vectara.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Vectara.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Vectara.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Vectara.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Vectara.AutoSDKClientOptions clientOptions,
            global::Vectara.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Vectara.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Vectara.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Vectara.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Vectara.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Vectara.IAutoSDKHook, global::Vectara.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Vectara.AutoSDKHookContext context)
        {
