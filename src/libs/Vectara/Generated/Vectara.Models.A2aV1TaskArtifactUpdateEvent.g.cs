...
namespace Vectara
{
    ...
    public sealed partial class A2aV1TaskArtifactUpdateEvent
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::Vectara.A2aV1Artifact Artifact { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="A2aV1TaskArtifactUpdateEvent" /> class.
        /// </summary>
        /// <param name="taskId">
        /// Identifier of the task that produced the artifact.
        /// </param>
...
#endif
        public A2aV1TaskArtifactUpdateEvent(
            string taskId,
            string contextId,
            global::Vectara.A2aV1Artifact artifact,
            bool? append,
            bool? lastChunk,
            object? metadata)
        {
