...
namespace Vectara
{
    public partial class UploadClient
    {
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_FileSecurityRequirement0 =
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_FileSecurityRequirement1 =
            new global::Vectara.EndPointSecurityRequirement
            {
                Authorizations = new global::Vectara.EndPointAuthorizationRequirement[]
                {                    new global::Vectara.EndPointAuthorizationRequirement
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement[] s_FileSecurityRequirements =
            new global::Vectara.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.Document> FileAsync(
            string corpusKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.Document>> FileAsResponseAsync(
            string corpusKey,
            ...
            try
            {
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // A document with the same document ID already exists in the corpus with different content. Delete the existing document first or use a unique document ID.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.Document>(
                                        statusCode: __response.StatusCode,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var request = new global::Vectara.UploadFileRequest
            {
                Metadata = metadata,
                ChunkingStrategy = chunkingStrategy,
                TableExtractionConfig = tableExtractionConfig,
