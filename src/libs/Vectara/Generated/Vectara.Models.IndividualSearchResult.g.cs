...
namespace Vectara
{
    ...
    public sealed partial class IndividualSearchResult
    {
        ...
        /// </summary>
        public static async global::System.Threading.Tasks.ValueTask<global::Vectara.IndividualSearchResult?> FromJsonStream(
        ...
        [global::System.Diagnostics.CodeAnalysis.RequiresDynamicCode("JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use System.Text.Json source generation for native AOT applications.")]
#endif
        public static global::System.Threading.Tasks.ValueTask<global::Vectara.IndividualSearchResult?> FromJsonStream(
            global::System.IO.Stream jsonStream,
            global::System.Text.Json.JsonSerializerOptions? jsonSerializerOptions = null)
        {
