...
namespace Vectara
{
    public partial class AgentSessionsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.AgentSession> CreateAsync(
            string agentKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.AgentSession>> CreateAsResponseAsync(
            string agentKey,
            ...
            try
            {
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // A session_enrichment tool call has an invalid configuration or its transform raised an error, so no session was created. `messages` names the failing tool call and the reason, such as a `$ref` to a secret that is not on the agent or in the request, or a jq error raised by the called tool configuration's `input_transform` or `output_transform`.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.AgentSession>(
                                        statusCode: __response.StatusCode,
