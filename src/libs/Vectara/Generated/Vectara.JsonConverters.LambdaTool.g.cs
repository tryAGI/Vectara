...
{
    /// <inheritdoc />
    public class LambdaToolJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vectara.LambdaTool>
    {
        /// <inheritdoc />
        public override global::Vectara.LambdaTool Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("tool_configurations")) __score1++;
            ...
            global::Vectara.LambdaToolVariant2? lambdaToolVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vectara.LambdaToolVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vectara.LambdaToolVariant2> ??
                                       throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Vectara.LambdaToolVariant2).Name}");
            ...
            var __value = new global::Vectara.LambdaTool(
                @base,
        ...
        public override void Write(
            ...
            global::Vectara.LambdaTool value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
