...
namespace Vectara.JsonConverters
{
    ...
    public class PipelineSourceJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Vectara.PipelineSource>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Vectara.GoogleDriveSourceConfiguration? googleDrive = default;
            if (discriminator?.Type == global::Vectara.PipelineSourceDiscriminatorType.GoogleDrive)
            {
            ...
            global::Vectara.WolkenFormsSourceConfiguration? wolkenForms = default;
            if (discriminator?.Type == global::Vectara.PipelineSourceDiscriminatorType.WolkenForms)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vectara.WolkenFormsSourceConfiguration), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vectara.WolkenFormsSourceConfiguration> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Vectara.WolkenFormsSourceConfiguration)}");
                wolkenForms = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, typeInfo);
            }
            global::Vectara.WolkenTicketsSourceConfiguration? wolkenTickets = default;
            if (discriminator?.Type == global::Vectara.PipelineSourceDiscriminatorType.WolkenTickets)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vectara.WolkenTicketsSourceConfiguration), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vectara.WolkenTicketsSourceConfiguration> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Vectara.WolkenTicketsSourceConfiguration)}");
            ...
            global::Vectara.FluidtopicsSourceConfiguration? fluidtopics = default;
            if (discriminator?.Type == global::Vectara.PipelineSourceDiscriminatorType.Fluidtopics)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vectara.FluidtopicsSourceConfiguration), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vectara.FluidtopicsSourceConfiguration> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Vectara.FluidtopicsSourceConfiguration)}");
                fluidtopics = global::System.Text.Json.JsonSerializer.Deserialize(ref reader, typeInfo);
            }
            global::Vectara.ScimSourceConfiguration? scim = default;
            if (discriminator?.Type == global::Vectara.PipelineSourceDiscriminatorType.Scim)
            {
            ...
            if (discriminator?.Type == global::Vectara.PipelineSourceDiscriminatorType.Web)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Vectara.WebSourceConfiguration), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Vectara.WebSourceConfiguration> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {nameof(global::Vectara.WebSourceConfiguration)}");
