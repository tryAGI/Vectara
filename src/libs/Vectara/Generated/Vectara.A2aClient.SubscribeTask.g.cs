...
namespace Vectara
{
    public partial class A2aClient
    {
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_SubscribeTaskSecurityRequirement0 =
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_SubscribeTaskSecurityRequirement1 =
            new global::Vectara.EndPointSecurityRequirement
            {
                Authorizations = new global::Vectara.EndPointAuthorizationRequirement[]
                {                    new global::Vectara.EndPointAuthorizationRequirement
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement[] s_SubscribeTaskSecurityRequirements =
            new global::Vectara.EndPointSecurityRequirement[]
            {                s_SubscribeTaskSecurityRequirement0,
                s_SubscribeTaskSecurityRequirement1,
            };
        partial void PrepareSubscribeTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref int? requestTimeout,
            ref int? requestTimeoutMillis,
            ref string agentKey,
            ref string taskId);
        partial void PrepareSubscribeTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string agentKey,
            string taskId);
        partial void ProcessSubscribeTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Subscribe to A2A v0.3 task updates<br/>
        /// Attach to a running task and stream subsequent lifecycle updates as Server-Sent Events. If the task is already terminal, streams the final task and closes.
        /// </summary>
        ...
        public async global::System.Collections.Generic.IAsyncEnumerable<global::Vectara.A2aV03StreamResponse> SubscribeTaskAsync(
            string agentKey,
            string taskId,
            ...
            [global::System.Runtime.CompilerServices.EnumeratorCancellation] global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Vectara.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SubscribeTaskSecurityRequirements,
                operationName: "SubscribeTaskAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Vectara.PathBuilder(
                                path: $"/v2/agents/{agentKey}/v1/tasks/{taskId}:subscribe",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "SubscribeTaskAsync",
                                pathTemplate: "$\"/v2/agents/{agentKey}/v1/tasks/{taskId}:subscribe\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                                ...
                                .Create(__stream).EnumerateAsync(__effectiveCancellationToken))
                            {
                                ...
                                var __streamedResponse = global::Vectara.A2aV03StreamResponse.FromJson(__content, JsonSerializerContext) ??
                                                       throw global::Vectara.ApiException.Create(
                                                           statusCode: __response.StatusCode,
