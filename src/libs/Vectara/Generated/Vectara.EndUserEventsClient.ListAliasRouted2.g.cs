...
namespace Vectara
{
    public partial class EndUserEventsClient
    {
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_ListAliasRouted2SecurityRequirement0 =
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_ListAliasRouted2SecurityRequirement1 =
            new global::Vectara.EndPointSecurityRequirement
            {
                Authorizations = new global::Vectara.EndPointAuthorizationRequirement[]
                {                    new global::Vectara.EndPointAuthorizationRequirement
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement s_ListAliasRouted2SecurityRequirement3 =
            new global::Vectara.EndPointSecurityRequirement
            {
                Authorizations = new global::Vectara.EndPointAuthorizationRequirement[]
                {                    new global::Vectara.EndPointAuthorizationRequirement
        ...
        private static readonly global::Vectara.EndPointSecurityRequirement[] s_ListAliasRouted2SecurityRequirements =
            new global::Vectara.EndPointSecurityRequirement[]
            {                s_ListAliasRouted2SecurityRequirement0,
                s_ListAliasRouted2SecurityRequirement1,
                s_ListAliasRouted2SecurityRequirement2,
                s_ListAliasRouted2SecurityRequirement3,
            };
        partial void PrepareListAliasRouted2Arguments(
            ...
            ref int? limit,
            ref string? pageKey);
        partial void PrepareListAliasRouted2Request(
            global::System.Net.Http.HttpClient httpClient,
            ...
            int? limit,
            string? pageKey);
        partial void ProcessListAliasRouted2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessListAliasRouted2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Vectara.ListEndUserEventsResponse> ListAliasRouted2Async(
            string aliasKey,
            string sessionKey,
        ...
        {
            var __response = await ListAliasRouted2AsResponseAsync(
                aliasKey: aliasKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Vectara.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Vectara.AutoSDKHttpResponse<global::Vectara.ListEndUserEventsResponse>> ListAliasRouted2AsResponseAsync(
            string aliasKey,
            string sessionKey,
            int? requestTimeout = default,
            int? requestTimeoutMillis = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareListAliasRouted2Arguments(
            ...
            var __authorizations = global::Vectara.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ListAliasRouted2SecurityRequirements,
                operationName: "ListAliasRouted2Async");
            ...
            if (xVisitorId != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareListAliasRouted2Request(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Vectara.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListAliasRouted2",
                                methodName: "ListAliasRouted2Async",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessListAliasRouted2Response(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Vectara.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // The session does not belong to the caller, or permissions do not allow reading its events. For an anonymous visitor, also returned when the session's connector no longer admits anonymous visitors. Also returned when the request `Origin` is not in the connector's `allowed_origins`. Origin checks apply only while the connector remains enabled; disabling or deleting it preserves the other admission and ownership checks.
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessListAliasRouted2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Vectara.ListEndUserEventsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Vectara.AutoSDKHttpResponse<global::Vectara.ListEndUserEventsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Vectara.ListEndUserEventsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
