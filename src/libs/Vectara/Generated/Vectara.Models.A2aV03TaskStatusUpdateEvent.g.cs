...
namespace Vectara
{
    ...
    public sealed partial class A2aV03TaskStatusUpdateEvent
    {
        ...
        /// <summary>
        /// True when this is the terminal status update for the task.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="A2aV03TaskStatusUpdateEvent" /> class.
        /// </summary>
        /// <param name="taskId">
        /// Identifier of the task whose status changed.
        /// </param>
...
#endif
        public A2aV03TaskStatusUpdateEvent(
            string taskId,
            string contextId,
