...
namespace Vectara
{
    ...
    {
        /// <summary>
        /// When the streaming event contains the next chunk of generator output, the type is `generation_chunk`.<br/>
        ...
        /// <summary>
        /// Part of the message from the generator. Append all chunks in order to get the full summary.
        /// </summary>
